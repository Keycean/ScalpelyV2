    ...
    return (
        <div className="homepage">
            ...
            <div 
                ...
                style={{ backgroundImage: "url('images/clone.jpg')" }}
            >
                ...
                <div className="content relative z-10 flex flex-col justify-between h-full w-full">
                    ...
                    {/* Main Section Cards */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl mx-auto bg-white bg-transparent p-6 mb-6">
                        <div className="card rounded-lg p-6 text-center bg-transparent">
                            <h3 className="text-xl  text-left text-white">FIND ONE OF OUR </h3>
                            <p className="text-xl font-bold  text-left text-white ">DOCTORS</p>
                        ...
                        <div className="card rounded-lg p-6 text-center bg-transparent">
                            ...
                            <p className="text-xl font-bold  text-left text-white ">APPOINTMENT</p>
                            <button className=" w-60 bg-transparent  shadow-lg border-solid border-2 border-white-500 text-white py-2 px-4 rounded-lg hover:bg-cyan-600">
                                Find a Doctor
                            </button>
                        </div>
                        <div className="card rounded-lg p-6 text-center bg-transparent">
                            ...
                            <p className="text-xl font-bold  text-left text-white ">DASHBOARD</p>
                            <button className=" w-60 bg-transparent  shadow-lg border-solid border-2 border-white-500 text-white py-2 px-4 rounded-lg hover:bg-cyan-600">
                                Find a Doctor
                            </button>
                        </div>
